                    ...
                    <div className="max-w-4xl mx-auto px-4 md:px-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-lg transition-all duration-300">
                                <h3 className="text-xl font-serif font-semibold mb-3 text-[#2C2418] flex items-start gap-3">
                                    <svg className="w-6 h-6 flex-shrink-0 mt-1 text-[#F4B942]" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                                    </svg>
                                    <span>When do you deliver?</span>
                                </h3>
                                <p className="text-[#2C2418]/70 leading-relaxed ml-9 text-lg">
